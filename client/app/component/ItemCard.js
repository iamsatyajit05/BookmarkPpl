...
import { Twitter, LinkedIn, Youtube, Github, Instagram, Book, Other, EditIcon, DeleteIcon } from './Svg';
    ...
    return (
        <>
            <div key={data._id} className="group relative bg-gray-800 rounded-lg">
                <a className="block h-full p-4 space-y-2" href={data.url} target="_blank">
                ...
                <div className='absolute top-2 right-2 hidden group-hover:block space-y-1'>
